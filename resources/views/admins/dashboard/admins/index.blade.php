                            ...
                            <table class="table" id="admintable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">{{ $admin->role_id }}</th>
                                        <th scope="col">
                                        @foreach ($admin->role_name as $role_name)
                                        {{ $role_name }}
                                        @endforeach
                                        </th>
                                        ...
                                        <a href="{{ route('admins.destroy',$admin->id) }}" class="btn btn-secondary  " >delete</a>
                                        </div>
                                        </th>
                                    </tr>
                                        @endforeach
