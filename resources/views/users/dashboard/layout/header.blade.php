		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="index.html"><img src="{{ asset('assets/user-dashboard/img/logo.png')}}" alt=""></a>
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        ...
                        <!-- End of Register and Login buttons -->
								...
								@php
									// Get the cart instance (adjust this according to your actual implementation)
